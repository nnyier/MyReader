      ...
      <div class="setting-wrapper"
        ...
        <div class="setting-theme"
          ...
          <div class="setting-theme-item"
            ...
            <div class="text"
                 :class="{'select': index === defaultTheme}">{{item.name}}</div>
          </div>
        </div>
        <div class="setting-progress"
          ...
          <div class="text-wrapper">{{bookAvailable?progress+'%':'加载中...'}}</div>
        </div>
      </div>
    </transition>
...
export default {
  ...
  methods: {
    ...
    setTheme(defaultTheme) {
      this.$emit("setTheme", defaultTheme);
    },
    showSetting(tag) {
      this.showTag = tag;
      if (this.showTag === 3) {
